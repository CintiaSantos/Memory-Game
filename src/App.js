      ...
      <div className="App">
        <header className="App-header">
          ...
          <p className="App-intro">
            Click an image to start! Do not click the same image twice!
          </p>
        </header>
        ...
        <footer>
          <p>Cintia's Github<a href="https://github.com/CintiaSantos/react-clicky-game" target="_blank" rel="noopener noreferrer"> here</a>.</p>
        </footer>
    </div>
    );
  }
